...
#define INCLUDE_TFT true     // display.cpp (TFT screen)
...
#define SD_MMC_CMD 9
#define SD_MMC_D0 8
#elif defined(CAMERA_MODEL_TTGO_T_CAMERA_PLUS) || defined(CAMERA_MODEL_ESP32S3_CAM_LCD)
...
#define DISPLAY_STACK_SIZE (1024 * 6)
